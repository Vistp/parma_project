...
function AddForm({ onSubmit }: { onSubmit: (values: IFormDrill) => Promise<ErrorInterface | SuccessInterface> }) {
  ...
  return (
    ...
    >
      <Form.Item
        label="Имя"
        name="name"
        rules={[{ required: true, message: 'Пожалуйста, введите ваше название!' }]}
      >
      ...
      <Form.Item
        label="Ключ"
        name="key"
        rules={[{ required: true, message: 'Пожалуйста, введите название ключа!' }]}
      >
